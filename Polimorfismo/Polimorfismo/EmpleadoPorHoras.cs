...
namespace Polimorfismo
{
    public class EmpleadoPorHoras : Empleado
    {
        ...
        public EmpleadoPorHoras (string nombre, string apellido, string nss, decimal sueldoPoHoras, decimal horasTrabajadas) : base (nombre, apellido, nss)
        {
            Sueldo = sueldoPoHoras;
